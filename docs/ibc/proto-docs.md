...
### ClientState
ClientState from Furyint tracks the current validator set, latest height,
...
### ConsensusState
ConsensusState defines the consensus state from Furyint.
...
### Header
Header defines the Furyint client consensus Header.
It encapsulates all the information necessary to update from a trusted
Furyint ConsensusState. The inclusion of TrustedHeight and
