...
func (m *ClientState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UpgradePath) > 0 {
		for iNdEx := len(m.UpgradePath) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintFuryint(dAtA, i, uint64(len(m.UpgradePath[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
	...
	i -= n3
	i = encodeVarintFuryint(dAtA, i, uint64(n3))
	i--
	dAtA[i] = 0x2a
	...
	i -= n4
	i = encodeVarintFuryint(dAtA, i, uint64(n4))
	i--
	dAtA[i] = 0x22
	...
	i -= n5
	i = encodeVarintFuryint(dAtA, i, uint64(n5))
	i--
	dAtA[i] = 0x1a
	{
...
func (m *ConsensusState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NextValidatorsHash) > 0 {
		...
		i = encodeVarintFuryint(dAtA, i, uint64(len(m.NextValidatorsHash)))
		i--
		dAtA[i] = 0x1a
	}
	{
	...
	i -= n8
	i = encodeVarintFuryint(dAtA, i, uint64(n8))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *Misbehaviour) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClientId) > 0 {
		...
		i = encodeVarintFuryint(dAtA, i, uint64(len(m.ClientId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Fraction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Denominator != 0 {
		i = encodeVarintFuryint(dAtA, i, uint64(m.Denominator))
		i--
		dAtA[i] = 0x10
	}
	if m.Numerator != 0 {
		i = encodeVarintFuryint(dAtA, i, uint64(m.Numerator))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Fraction) Size() (n int) {
	...
	_ = l
	if m.Numerator != 0 {
		n += 1 + sovFuryint(uint64(m.Numerator))
	}
	if m.Denominator != 0 {
		n += 1 + sovFuryint(uint64(m.Denominator))
	}
	return n
}
