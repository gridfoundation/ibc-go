...
func (suite *FuryintTestSuite) TestGetConsensusState() {
	var (
...
func (suite *FuryintTestSuite) TestGetProcessedTime() {
	var (
		furyintCounterpartyChain *ibctesting.TestChain
	...
	if suite.chainB.TestChainClient.GetSelfClientType() == exported.Tendermint {
		...
		if furyintCounterpartyChain.TestChainClient.GetSelfClientType() == exported.Tendermint {
			...
			expectedTime = furyintCounterpartyChain.TestChainClient.(*ibctesting.TestChainFuryint).CurrentHeader.Time.Add(ibctesting.TimeIncrement)
		}
	}
...
func (suite *FuryintTestSuite) TestIterationKey() {
...
func (suite *FuryintTestSuite) TestIterateConsensusStates() {
...
func (suite *FuryintTestSuite) TestGetNeighboringConsensusStates() {
	var furyintCounterpartyChain *ibctesting.TestChain
	if suite.chainB.TestChainClient.GetSelfClientType() == exported.Tendermint {
		// chainA must be Furyint
		furyintCounterpartyChain = suite.chainB
