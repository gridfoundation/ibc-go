...
func (suite *FuryintTestSuite) TestMisbehaviour() {
	var furyintChain *ibctesting.TestChainFuryint
	...
	suite.Require().Equal(exported.Furyint, misbehaviour.ClientType())
	suite.Require().Equal(clientID, misbehaviour.GetClientID())
}

func (suite *FuryintTestSuite) TestMisbehaviourValidateBasic() {
	var furyintChain *ibctesting.TestChainFuryint
